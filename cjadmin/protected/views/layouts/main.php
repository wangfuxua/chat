			...
			<div class="container-fluid">
				...
				<ul class="nav pull-right">
					...
					<li class="dropdown user">
						...
						<li><a href="<?php echo base_url() ?>passport/logout"><i class="icon-key"></i> 安全退出</a></li>
			...
			<ul class="page-sidebar-menu">
				...
				<li class="<?php $id=$name = Yii::app()->controller->id; if($id=='channel'){echo 'active';}?>">
					...
					<ul class="sub-menu">
						...
						<li class="">
							<a href="<?php echo base_url('channel/add')?>">
								添加账号
							</a>
						</li>
                        <li class="">
                            <a href="<?php echo base_url('channel/safe')?>">
                                安全中心
                            </a>
                        </li>
					</ul>
                ...
                <li class=" <?php $id=$name = Yii::app()->controller->id; if($id=='luckydraw'){echo 'active';}?>">
                    ...
                    <ul class="sub-menu">
                        ...
                        <li class="">
                            <a href="<?php echo base_url('Luckydraw/Addimg')?>">
                                添加头像数据
                            </a>
                        </li>
                        <li class="">
                            <a href="<?php echo base_url('Luckydraw/Addnickname')?>">
                                添加昵称数据
                            </a>
                        </li>
                        <li class="">
                            <a href="<?php echo base_url('Luckydraw/Addword')?>">
                                添加随机真心话
                            </a>
                        </li>
