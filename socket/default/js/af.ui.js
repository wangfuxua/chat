...
(function($) {
    ...
    AFUi.prototype = {
        ...
        */
        ...
        /**
         * 自定义方法 goPanel(target)
         *
         * @title $.afui.goPanel(target,callback)
         * @param {string} target panel's id
         * @param {function} callback function to do something
         *
         **/
         goPanel:function(target,callback,transition){

            // var trans = transition || "slide-right";

            this.runTransition("slide-right","#" + this.activeDiv.id,"#" + target,false);

            this.activeDiv = document.getElementById(target);
            this.updateHash(target);

            this.updateViewHistory($("#mainview"),document.getElementById(target),"slide-right",target);
